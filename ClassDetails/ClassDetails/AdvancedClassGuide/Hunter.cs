...
{
    public class Hunter : ClassFoundation 
    {
        public Hunter()
        {
            Name = "Hunter";
            ...
            ClassArchetypes = new List<string>() { "Feral Hunter", "Verminous Hunter" };
        ...
        {
            return new List<string> { StatBlockInfo.SkillNames.CLIMB, StatBlockInfo.SkillNames.CRAFT, StatBlockInfo.SkillNames.HANDLE_ANIMAL, StatBlockInfo.SkillNames.HEAL, StatBlockInfo.SkillNames.INTIMIDATE, StatBlockInfo.SkillNames.KNOWLEDGE_DUNGEONEERING, 
                StatBlockInfo.SkillNames.KNOWLEDGE_GEOGRAPHY, StatBlockInfo.SkillNames.KNOWLEDGE_NATURE, StatBlockInfo.SkillNames.PERCEPTION, StatBlockInfo.SkillNames.PROFESSION, StatBlockInfo.SkillNames.RIDE, StatBlockInfo.SkillNames.SPELLCRAFT, StatBlockInfo.SkillNames.STEALTH, 
        ...
        public override int ClassFeatCount(int ClassLevel, string Archetype)
        {
            ...
            int count = 0;
            if (ClassLevel >= 2) count++; //Precise Shot or Outflank
